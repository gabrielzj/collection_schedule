<template>
  <ion-modal v-if="isOpen" :is-open="isOpen" @didDismiss="closeModal">
    <ion-page>
      <ion-header>
        <ion-toolbar>
      ...
      <ion-content class="ion-padding">
        ...
        <div v-if="props.id === 1">
          ...
          <p>
            ...
            guardanapos não serão reciclados, portanto, devem ser descartados no
            lixo comum.
          </p>
          ...
          <p>
            Antes de descartar, avalie se o papel pode ser <b>reutilizados.</b>
            ...
            podem ser reutilizadas para armazenamento ou organização de objetos.
          </p>
          ...
          <p>
            ...
            caixas e amasse os papéis volumosos para ajudar a otimizar o espaço
            dos caminhões de coleta. Separe um local adequado e seco e mantenha
            os resíduos descartados separados dos demais. Remova restos de
            comida e limpe antes do descarte.
          </p>
        ...
        <div v-if="props.id === 2">
          ...
          <p>
            ...
            restos de produtos. Isso evita a proliferação de bichos e permite
            que o resíduo seja considerado reciclável. Após feita limpeza
            mantenha os resíduos em locais secos, para evitar corrosão.
          </p>
          <p>
            Remova rótulos plásticos, etiquetas e separe tampas. O plástico e
            papel podem ser encaminhados para reciclagem separadamente. Latas de
            alumínio podem ser facilmente amassadas para reduzir o volume do
            lixo descartado.
          </p>
          ...
          <p>
            ...
            vazios, mantenha esses tipos de resíduos fora do alcance de crianças
            e animais. Nunca amasse ou perfure latas de aerossóis, pois isso
            pode causar liberação de gases ou até explosões.
          </p>
          <p>
          ...
          <p>
            ...
            evitar vazamentos e mau cheiro. Procure envolver objetos cortantes e
            pontiagudos em mais de um saco ou sacola, garantindo maior segurança
            para catadores. Evite descartar resíduos metálicos com outros tipos
            de resíduos.
          </p>
        ...
        <div v-if="props.id === 3">
          ...
          <p>
            ...
            materiais quando possível. Tampas que não forem plásticas devem ser
            separadas.
          </p>
          ...
          <p>
            ...
            para aterros e ajuda a economizar recursos naturais, como petróleo e
            energia, utilizados na produção de novos plásticos. O
            reaproveitamento desses materiais também diminui a poluição de rios
            e oceanos, prevenindo impactos na fauna e flora.
          </p>
          <p>
        ...
        <div v-if="props.id === 5">
          ...
          <ul>
            ...
            <li>
              Mantenha em local ventilado e esvazie com frequência (diariamente
              ou conforme a coleta).
            </li>
            <li>
        ...
        <div v-if="props.id === 6">
          ...
          <ul>
            <li>
              Mantenha garrafas, potes, refratários, pratos entre outos objetos
              a serem descartados separados de outros tipos de resíduos
            </li>
            <li>
              Separe vidros quebrados em embalagem protegida (papelão ou
              jornal), e armazene em caixas rígidas ou envolva em mais de um
              saco de lixo. Se possível identifique naa caixa ou saco a presença
              de vidro quebrado.
            </li>
          ...
          <ul>
            ...
            <li>
              ...
              empresas especializadas para que possam fazer o descarte e
              manuseio do vidro de forma segura.
            </li>
          </ul>
        ...
        <div v-if="props.id === 7">
          ...
          <p>
            ...
            sanitários, onde recebem tratamento adequado para minimizar impactos
            ambientais.
          </p>
          ...
          <p>
            ...
            com luvas para evitar contaminação. Evite misturar com outros tipos
            de resíduos.
          </p>
          <div class="container">
            <ion-icon :icon="locationOutline"></ion-icon>
